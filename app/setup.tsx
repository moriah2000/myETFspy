...
const styles = StyleSheet.create({
  ...
  searchContainer: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#141A26', borderRadius: 10, paddingHorizontal: 12, marginBottom: 16, borderWidth: 0.5, borderColor: 'rgba(255,255,255,0.06)' },
  ...
  etfChip: { paddingHorizontal: 16, paddingVertical: 10, borderRadius: 10, backgroundColor: '#141A26', borderWidth: 0.5, borderColor: 'rgba(255,255,255,0.06)' },
  ...
  selectedRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: '#141A26', borderRadius: 10, padding: 12, marginBottom: 8, borderWidth: 0.5, borderColor: 'rgba(51,141,255,0.2)' },
  ...
  holdingInputRow: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#141A26', borderRadius: 12, padding: 12, marginBottom: 10, gap: 12, borderWidth: 0.5, borderColor: 'rgba(255,255,255,0.06)' },
  ...
  holdingInputs: { flex: 1, gap: 8 },
  input: { backgroundColor: '#0B0F19', borderRadius: 8, padding: 10, color: '#E8EEF8', fontSize: 13, borderWidth: 0.5, borderColor: 'rgba(255,255,255,0.06)' },
